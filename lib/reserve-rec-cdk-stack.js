...
class ReserveRecCdkStack extends Stack {
  constructor(scope, id, props) {
    ...
    // Explicitly attach the authorizers to the API to avoid the CDK bug:
    // Resolution error: Authorizer must be associated with an API.
    authorizerResources.publicRequestAuthorizer._attachToApi(apigwResources.api);
    authorizerResources.adminRequestAuthorizer._attachToApi(apigwResources.api);
